            ...
            <div className='h-64 w-64 bg-white p-4 rounded-xl hover:ring hover:ring-blue-500 group'>
                {
                  ...
                  <div className='h-full w-full flex flex-col'>
                    ...
                    <div className='flex-1 relative overflow-clip rounded-xl'>
                      <img src="https://media.wired.com/photos/59268c5dcfe0d93c474309a2/master/w_1600,c_limit/BSP_054.jpg" alt="NASA" className='object-none h-full w-full rounded-xl group-hover:scale-150 duration-500 group-hover:rotate-12'/>
